...
pieces of paper with numbers on them and asks you to compose the largest number
from these numbers. The resulting number is going to be your salary, so you are
very interested in maximizing this number.
...
public class LargestNumber {
    public static void main(String[] args) {
        ...
        System.out.println(maximize(numbers));
    }
